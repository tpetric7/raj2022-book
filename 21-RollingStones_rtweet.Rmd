...
start = as_datetime("2021-08-24 16:38:55")
...
anim_graph <- tweets_rollingstones_time %>%
  ...
  labs(title = "Tweets about Rolling Stones: Time { round(frame_time) }") +
  theme(legend.position = "none")

animate(anim_graph, nframes = 400, fps = 4)

anim_save("pictures/rolling_stones_tweets_animated.gif")
```
